...
class NotifyController extends Controller
{
    ...
    public function do_index(){
        ...
        // if($order_info['pay_memberid'] == '10002'){
            ...
            logApiAddReceipt('YunPay回调下游商户信息', __METHOD__, $order_info['pay_orderid'], $order_info['out_trade_id'], $order_info["pay_notifyurl"], $notifystr, substr($contents,0,2000), $doTime, $httpCode, '2', '2');
        // }
        //记录向下游异步通知日志
