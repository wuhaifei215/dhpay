	...
	<div class="main">
		 <form target="_blank" method="post" action="dodf.php">
			<ul>
				...
				<li>
					<label>通道编码</label>
					<input type="text" name="bankcode" value="906" />
				</li>
				<li>
					<label>开户行</label>
				...
				<li>
					<label>是否到卡</label>
					<input type="text" name="type" value="" />（1否，2是）
				</li>
				<!--<li>
					<label>身份证号</label>
				...
				<li>
					<label>回调地址</label>
					<input type="text" name="notifyurl" value="https://glht.sqpay77.com/dhfpay/notify.php"  />
				</li>
