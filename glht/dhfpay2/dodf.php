...
$mchid = "10004";  
$Md5key = "pa92wj1af7j4wa2qwm2z7zu6yy0n6dlm";
...
if(empty($mchid)||empty($_POST['money'])||empty($_POST['bankname']) 
	|| empty($_POST['accountname']) || empty($_POST['cardnumber']) ){
		die("信息不完整！");
}
if($_POST['extends']) {
...
if($_POST['bankcode']=='909'){
    $tjurl = "https://api.sqpay77.com/Payment_CreateDF_payoutINR.html";   //提交地址
}else{
    $tjurl = "https://api.sqpay77.com/Payment_CreateDF_payoutPHP.html";   //提交地址
}
