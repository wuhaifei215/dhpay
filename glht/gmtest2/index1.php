...
$pay_memberid = "10004";//商户ID
$Md5key = "pa92wj1af7j4wa2qwm2z7zu6yy0n6dlm";   //密钥
...
$pay_callbackurl = $http_type . "glht.sqpay77.com/gmtest/page.php";  //页面跳转返回地址
if($pay_bankcode=='909'){
    $tjurl = $http_type . "api.sqpay77.com/Pay_Create_payinINR.html";   //提交地址
}else{
    $tjurl = $http_type . "api.sqpay77.com/Pay_Create_payinPHP.html";   //提交地址
}
